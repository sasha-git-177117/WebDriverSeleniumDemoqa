...
public class BrowserWindowPage extends BaseForm {
    private static final By CHECK_ELEMENT = By.xpath("//*[@id='browserWindows']");
    private static final By BY_NEW_TAB_BUTTON = By.xpath("//*[@id='tabButton']");
    ...
    private static final Button NEW_TAB_BUTTON = new Button(BY_NEW_TAB_BUTTON,"newTabButton");
    ...
    public void clickNewTab() {
        LoggerUtils.info("Нажимается кнопка "+ NEW_TAB_BUTTON.getName());
